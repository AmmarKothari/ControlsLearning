...
%             obj.Kd = 0.1;
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            % only take into account sensor if there is a reading
            for i = 1:n_sensors
                if norm(ir_distances_wf(:,i)) < 0.35
                    sensor_gains(i) = 1;
                end
            end
            sensor_gains = [3, 2, 1, 2, 3];
                    
            u_i = (ir_distances_wf - [x, y]') * sensor_gains';
            u_ao = sum(u_i,2);
...
%             fprintf('(v,w) = (%0.4g,%0.4g)\n', v,w);
        ...
        function ir_distances_wf = apply_sensor_geometry(obj, ir_distances, state_estimate)
            ...
            for i=1:n_sensors
                ...
                d_s = [ir_distances(i), 0, 1]';
                ir_distances_rf(:,i) = R * d_s; % robot frame
            end
            ...
            ir_distances_wf = R * ir_distances_rf; % world frame
